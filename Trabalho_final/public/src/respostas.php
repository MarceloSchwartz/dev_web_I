...
$feedback_textual = ($feedback_textual !== false && !empty($feedback_textual)) ? $feedback_textual : NULL; 

if ($pergunta_id === false || $nota === false || $numero_pergunta === false || $id_dispositivo === false) {
    die("Erro de dados: ID da pergunta, nota ou número de sequência inválido ou faltando.");
}
...
try {
    ...
    if ($proxima_pergunta > $total_perguntas) {
